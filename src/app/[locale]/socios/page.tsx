...
const partners = [
  { name: 'Vimenti', descKey: 'vimentiDesc', accent: 'oasis-teal' },
  { name: 'Project Makers', descKey: 'projectMakersDesc', accent: 'oasis-coral' },
  { name: 'IDJ', descKey: 'idjDesc', accent: 'oasis-purple' },
  { name: 'Goodwill / Excel Center', descKey: 'goodwillDesc', accent: 'oasis-gold' },
  { name: 'PSI', descKey: 'psiDesc', accent: 'oasis-navy' },
] as const;
    ...
    <>
      ...
      <section className="bg-white px-6 py-20">
        <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
          {partners.map(({ name, descKey, accent }) => (
            <article
              key={name}
